                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($kota as $data)
                                        ...
                                        <tr>
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{route('kota.show',$data->id)}}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                            <a class="btn btn-warning btn-sm btn-rounded " href="{{route('kota.edit',$data->id)}}"> <i class="fa fa-edit"></i></a>
