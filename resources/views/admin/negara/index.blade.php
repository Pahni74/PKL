            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                        <div class="card-body">
                                <h4 class="card-title">List Negara
                                    <a class="btn btn-primary btn-sm btn-rounded" href="{{route('negara.create')}}"><i class="fa fa-plus"></i></a></h4>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($negara as $data)
                                        ...
                                        <tr>
                                            ...
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{route('negara.show',$data->id)}}" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                            <a class="btn btn-warning btn-sm btn-rounded " href="{{route('negara.edit',$data->id)}}"> <i class="fa fa-edit"></i></a>
